...
try {
  ...
  console.log('Native Electron file-page reading storage passed: real Web Locks, WebCrypto, localStorage and fresh-process read of synthetic marks/bookmark/Unicode notes. Paired-package restore/reimport, batch status/undo, pending research draft/hash/task identity and fresh-process persisted manual marks also passed. Not a full application UI test.')
