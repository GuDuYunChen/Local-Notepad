...
it('shows explicit lab scope and identity',async()=>{await render();expect(container.textContent).toContain('不把实验室伪装成正式云同步');expect(container.textContent).toContain('当前同步笔记、文件夹、标签、标签关联和附件');expect(container.textContent).toContain('device-a')})
